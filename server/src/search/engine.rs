...
mod tests {
    ...
    use super::result_url;

    #[test]
    fn unwraps_bing_encoded_result_url() {
        let base = Url::parse("https://www.bing.com/search?q=rust").unwrap();
        let result = result_url(&base, "/ck/a?u=a1aHR0cHM6Ly9ydXN0LWxhbmcub3Jn&ntb=1").unwrap();

        assert_eq!(result, "https://rust-lang.org");
    }
}
